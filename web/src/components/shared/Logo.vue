  ...
  <div class="logo-container">
    <div class="logo-content">
      <div class="logo-image">
        <img width="110" src="@/assets/images/mindbot_logo_mini.webp" alt="MindBot Logo">
      </div>
      <div class="logo-text">
        <h2 
...
const formatTitle = (title: string) => {
  // 如果标题包含 "MindBot" 和其他文字，在它们之间添加换行机会
  if (title.includes('MindBot ') || title.includes('MindBot')) {
    // 处理 "MindBot 仪表盘" 或 "MindBot Dashboard" 等格式
    return title.replace(/(MindBot)\s+(.+)/, '$1<wbr> $2');
  }
  return title;
}
</script>

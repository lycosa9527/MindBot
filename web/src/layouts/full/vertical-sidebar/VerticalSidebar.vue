...
function openIframeLink(url) {
  if (typeof window !== 'undefined') {
    let url_ = url || "https://github.com/lycosa9527/MindBot";
  ...
  >
    <div class="sidebar-container">
      ...
      <div class="sidebar-footer" v-if="!customizer.mini_sidebar">
        ...
        <v-btn style="margin-bottom: 8px;" size="small" variant="plain" @click="openIframeLink('https://github.com/lycosa9527/MindBot')">
  ...
  >
    ...
    <div :style="dragHeaderStyle" @mousedown="onMouseDown" @touchstart="onTouchStart">
      ...
      <div style="display: flex; gap: 8px;">
        ...
        <v-btn
          icon
          @click.stop="openIframeLink('https://github.com/lycosa9527/MindBot')"
          @mousedown.stop
    ...
    <!-- iframe 区域 -->
    <iframe
      src="https://github.com/lycosa9527/MindBot"

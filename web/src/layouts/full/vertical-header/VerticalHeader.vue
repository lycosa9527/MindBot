...
function getDevCommits() {
  ...
  const originalUrl = "https://api.github.com/repos/lycosa9527/MindBot/commits";
...
<template>
  <v-app-bar elevation="0" height="55">
    ...
    <div class="logo-container" :class="{'mobile-logo': $vuetify.display.xs}" @click="$router.push('/about')">
      <span class="logo-text">Mind<span class="logo-text-light">Bot</span></span>
        ...
        <v-card-text>
          <v-container>
              ...
              <v-tabs-window-item key="0" v-show="tab == 0">
                ...
                >
                  ...
                  <div class="text-body-2">
                    ...
                    <a href="https://github.com/lycosa9527/MindBot/issues" target="_blank" class="text-decoration-none">
            ...
            <div class="mb-4">
              ...
              <br>
              <a href="https://github.com/lycosa9527/MindBot/commits/master"><small>{{ t('core.header.updateDialog.manualInput.linkText') }}</small></a>
            </div>
